    ...
    def train(self):
        ...
        for e in range(self.epoch):
            for i, batch_images in enumerate(self.data_loader):
                ...
                real_label = self.to_var(torch.FloatTensor(batch_size).fill_(1.))
                fake_label = self.to_var(torch.FloatTensor(batch_size).fill_(0.))
                # train D
            ...
            if (e+1) % self.save_image_step == 0:
                ...
                save_image(fake_image.data, os.path.join(self.image_save_path, "{}_fake.png".format(e+1)))
